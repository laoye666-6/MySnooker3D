...
public static class BuildGame
{
    public static void BuildAndroid()
    {
        ...
        // 版本 0.43（第 43 次迭代）：对外显示的迭代版本号；versionCode 递增供安装覆盖
        PlayerSettings.bundleVersion = "0.43";
        ...
        bool bad = false;
        if (PlayerSettings.bundleVersion != "0.43") { Debug.LogError("[SNOOKER] bundleVersion 未生效"); bad = true; }
        if (PlayerSettings.Android.bundleVersionCode < 43) { Debug.LogError("[SNOOKER] versionCode 未生效"); bad = true; }
