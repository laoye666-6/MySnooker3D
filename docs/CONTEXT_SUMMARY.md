# 双人斯诺克 3D —— 项目上下文总结（截至 v0.35，2026-09-19）
...
**已开源**：https://github.com/laoye666-6/MySnooker3D （public / MIT，Release v0.35 含 APK）
**交付物**：`E:\Snooker3D\Builds\Snooker3D.apk`（v0.35，双架构 ARM64+X86_64，IL2CPP，约 70MB，已装 MuMu）
...
| 文档 | `E:\Snooker\README.md`（踩坑 + 版本记录 v0.28~v0.35）、本文件、`DSH_IMPORT_PROMPT.txt` |
...
- `G.cs` — 全局常量：球桌尺寸(米)、袋口捕获半径、滚动摩擦 0.11、出杆初速 0.55~6.0、
  停判阈值 0.09、置球点、分值/颜色/中文名、ColorOrder
...
- `BallController.cs` — 落袋/下沉/重置/滚动摩擦/碰撞上报
...
- **v0.35**（当前）— **补齐官方细则**：指定彩球(Rule 3(f)(i)(b)，准线指向自动指定，参与罚分)、
